...
> Snapshot: PRD mtime 2026-04-18 09:12, TASKS mtime 2026-04-19 14:25.
...
> Snapshot: PRD mtime YYYY-MM-DD HH:MM, TASKS mtime YYYY-MM-DD HH:MM.
```
...
- **`Snapshot`** captura `mtime` (timestamp de modificação) do PRD e
  do TASKS no momento da pausa. Usado pela retomada para detectar
  drift — sem `Snapshot`, a skill não consegue distinguir retomada
  limpa de retomada após edição manual.
...
| `lacuna-prd` | Detectada ambiguidade, contradição ou regra ausente no PRD que bloqueia decisão. |
...
### `lacuna-prd` — adiciona linha de premissa quando o usuário decide inline
...
```
> Pausa em 2026-04-19 10:05: lacuna-prd — Rule "rate limit por IP" não define janela de tempo.
> Ciclos consumidos: 0. Última ação: passo T05.2.
> Erro final: —.
> Premissa registrada inline: assumida janela de 60 segundos por IP.
> Snapshot: PRD mtime 2026-04-18 09:12, TASKS mtime 2026-04-19 10:00.
```
...
> Snapshot: PRD mtime 2026-04-20 10:00, TASKS mtime 2026-04-20 15:08.
```
...
> Snapshot: PRD mtime 2026-04-19 18:00, TASKS mtime 2026-04-19 17:50.
```
...
> Snapshot: PRD mtime 2026-04-18 09:12, TASKS mtime 2026-04-19 15:50.
```
...
> Pausa em 2026-04-15 11:20: lacuna-prd — PRD não define se idempotência é por order_id ou por hash do body.
> Ciclos consumidos: 0. Última ação: passo T07.2.
> Erro final: —.
> Snapshot: PRD mtime 2026-04-15 09:00, TASKS mtime 2026-04-15 11:00.

> Pausa em 2026-04-16 09:45: lacuna-prd — Rule "retry com backoff" não define teto de tentativas.
...
> Snapshot: PRD mtime 2026-04-16 08:30, TASKS mtime 2026-04-16 09:30.
...
> Snapshot: PRD mtime 2026-04-17 09:00, TASKS mtime 2026-04-17 14:05.
```
